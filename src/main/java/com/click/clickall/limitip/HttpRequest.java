...
public class HttpRequest {
    ...
    public static void main(String[] args) {
        ...
        System.getProperties().setProperty("http.proxyHost", "103.22.40.32");
        System.getProperties().setProperty("http.proxyPort", "80");
        // 判断代理是否设置成功
        // 发送 GET 请求
        System.out.println(sendPost("http://pacx.51ideal.com/index.php/api/reg",
                "email=nuomo7364@sina.com&phone=18966662533&name=张斌&pass=liao894779&checkcode=nlhdh"));
        // 发送 POST 请求
    }
